...
function Card({ title, category, price, id, thumbnail }) {
    ...
    return (
        <div className='max-w-sm w-full bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-gray-300 hover:shadow-amber-300 cursor-pointer' onClick={() => navigate(`/viewcourse/${id}`)}>
