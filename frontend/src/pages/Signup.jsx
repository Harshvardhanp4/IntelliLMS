      ...
      >
        ...
        <div className="md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3">
          <div>
            ...
            <h2 className="text-[#999797] text-[18px] pl-2">
              Create your account
            </h2>
          </div>
          ...
          <div className="flex md:w-[50%] w-[70%] items-center justify-between">
            <span
              className={`px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-4xl cursor-pointer hover:border-black ${
          ...
          <button
            type="button"
            className="w-[80%] h-[50px] text-white bg-black hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 cursor-pointer"
            disabled={loading}
          ...
          <div
            className="w-[80%] h-[40px] border-1 border-black rounded-[5px]n flex items-center justify-center "
