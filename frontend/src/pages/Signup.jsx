           ...
           <form className='w-[90%] md:w-200 h-150 bg-white shadow-xl rounded-2xl flex'>
                ...
                <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3'>
                    ...
                    <div className='flex md:w-[50%] w-[70%] items-center justify-between'>
                        <span className='px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-4xl cursor-pointer hover:border-black'>Student</span>
                        <span className='px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-4xl cursor-pointer hover:border-black'>Educator</span>
                    </div>

                    {/* button */}
                    <button type="button" class="w-[80%] h-[40px] text-white bg-black hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 cursor-pointer">Sign Up</button>
